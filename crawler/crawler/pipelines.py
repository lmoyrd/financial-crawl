...
from crawler.util.postgre import KCBPostgreConnector, CYBPostgreConnector, ZBPostgreConnector
...
class KCBPipeline(BasePipeline):
    item_to_func = {
        # 科创板
        "IPOItem" : "ipo",
        "CompanyItem": "company",
        "CompanyManagerItem": "company_manager",
        "IntermediaryItem": "intermediary",
        "KCBIntermediaryItem": "intermediary_item",
        "KCBIntermediaryPersonItem": "person_item",
        "KCBCompanyMilestoneItem": "milestone",
        "KCBCompanyProcessItem": "process",
        "KCBCompanyOtherItem": "other",
        "KCBFileItem": "file",
        "MarketCountItem" : "count",
    }
    connector = KCBPostgreConnector()

class CYBPipeline(BasePipeline):
    item_to_func = {
        # 创业板
        "CYBIPOItem" : "ipo",
        "CYBCompanyItem": "company",
        "CYBIntermediaryItem": "intermediary_item",
        "CYBIntermediaryPersonItem": "person_item",
        "CYBCompanyMilestoneItem": "milestone",
        "CYBCompanyOtherItem": "other",
        "CYBFileItem": "file",
        "MarketCountItem" : "count",
    }
    connector = CYBPostgreConnector()
