...
from crawler.converter.sh_zrz import\
...
# =============================================================================
class SH_ZRZ_Spider(BaseSpider, scrapy.Spider):
    name = "sh_zrz"

    target_url = 'http://query.sse.com.cn/zrzStatusAction.do'
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SH_ZRZ_Spider, cls).from_crawler(crawler, *args, **kwargs)
