...
from crawler.converter.sz_zrz import\
...
# =============================================================================
class SZ_ZRZ_Spider(BaseSpider, scrapy.Spider):
    name = "sz_zrz"
    ...
    headers = {
        "Referer": "https://listing.szse.cn/projectdynamic/refinance/index.html",
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SZ_ZRZ_Spider, cls).from_crawler(crawler, *args, **kwargs)
