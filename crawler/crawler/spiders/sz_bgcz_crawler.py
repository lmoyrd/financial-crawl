...
from crawler.converter.sz_bgcz import\
...
# =============================================================================
class SZ_BGCZ_Spider(BaseSpider, scrapy.Spider):
    name = "sz_bgcz"
    ...
    headers = {
        "Referer": "https://listing.szse.cn/projectdynamic/reproperty/index.html",
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SZ_BGCZ_Spider, cls).from_crawler(crawler, *args, **kwargs)
